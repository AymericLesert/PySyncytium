...
class DSCriteriaComparableLessOrEqual(DSCriteriaComparable):
    """
    This class handles a less or equality criteria between :
    ...
    def to_dict(self):
        """Convert a less or equality criteria to a dict"""
